...
class DashboardPage extends BasePage {
    ...
    // LOCATOR PATHS
    private readonly successPopupText: string = `div#root li div div:nth-child(2)`;
    ...
    private readonly errorMessage: Locator = this.page.locator(this.successPopupText);
    ...
    async waitForSuccessPopup(): Promise<void> {
        await this.waits.waitForLoad(this.page, this.successPopupText);
    }
